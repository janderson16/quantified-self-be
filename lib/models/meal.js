...
function all(query) {
  ...
  return database.select(`${TABLES.FOODS}.name`, `${TABLES.FOODS}.calories`, `${TABLES.MEAL_FOODS}.date`, `${TABLES.MEALS}.name AS meal_name`)
    .from(TABLES.FOODS)
...
function find_by(name, query) {
  ...
  return database.select(`${TABLES.FOODS}.name`, `${TABLES.FOODS}.calories`, `${TABLES.MEAL_FOODS}.date`)
    .from(TABLES.FOODS)
    .innerJoin(TABLES.MEAL_FOODS, `${TABLES.MEAL_FOODS}.food_id`, `${TABLES.FOODS}.id`)
    .innerJoin(TABLES.MEALS, `${TABLES.MEAL_FOODS}.meal_id`, `${TABLES.MEALS}.id`)
    .where(whereClause)
